...
def distance_pattern_dtw(data: np.ndarray, significanceLevel: float = 0.01, wSlopeError: float = 1, wCurvatureError: float = 1) -> Tuple[np.ndarray, List[Tuple[Dict[str, str], np.ndarray]]]:
    """
