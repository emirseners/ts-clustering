...
def distance_manhattan(data: np.ndarray) -> Tuple[np.ndarray, List[Tuple[Dict[str, str], np.ndarray]]]:
    """
    Calculate pairwise Manhattan distances between all data sequences.
    ...
    dRow = pdist(data, metric='cityblock')
